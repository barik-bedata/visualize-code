...
class Optimal(Scene):
    def construct(self):
        ...
        nums1_empty_highlighter = RangeHighlighter(self, typo.color_blue_gray())
        nums1_empty_highlighter.create(nums1.cells, 3, 5)
        nums1_empty_highlighter.effect_highlight_show()
        self.wait(1.5)
        nums1_empty_highlighter.effect_highlight_hide()
        ...
        # ── sort/fix cells silently (simulating final result) ──────────
        # Here we use set_value to show the final sorted state
