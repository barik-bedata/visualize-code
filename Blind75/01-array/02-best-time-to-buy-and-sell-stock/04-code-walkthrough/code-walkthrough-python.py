...
class WalkthroughPython(Scene):
    def construct(self):
        ...
        min_price_title = Text("min_price:", font=typo.font_code(), font_size=18, color=LIGHT_TEXT)
    ...
    def max_profit(self, prices: List[int]) -> int:
        ...
        # Line 10: return max_profit
        self.play(highlight_line(10))
